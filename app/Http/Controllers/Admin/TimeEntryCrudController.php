...
use App\Http\Requests\TimeEntryRequest as StoreRequest;
use App\Http\Requests\TimeEntryRequest as UpdateRequest;

class TimeEntryCrudController extends CrudController
{
...
//         $this->crud->addButton('top', 'Report', 'view', $content); // add a button; possible types are: view, model_function
